...
public class InternateNewsPanel extends Panel implements AfterCompose {
	...
	private Listbox internateNewsList;
	public void afterCompose() {
		Components.wireVariables(this, this);
		Components.addForwards(this, this);
		List<WkTInfo> pinfolist0 = infoIdAndDomainId.internateNews();
		...
		internateNewsList.setModel(new ListModelList(pinfolist1));
		internateNewsList.setItemRenderer(new ListitemRenderer(){
