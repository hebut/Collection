...
public class InfoDetailShow extends Window implements AfterCompose {
	...
	public void afterCompose() {
		...
		String infoId = (String)Sessions.getCurrent().getAttribute("infoId");
		if(infoId!=null&&!infoId.trim().equals("")){
			info = info_newsService.getWkTInfo(Long.valueOf(infoId.trim()));
			try {
				initWindow(info);
			} catch (IOException e) {
			}
