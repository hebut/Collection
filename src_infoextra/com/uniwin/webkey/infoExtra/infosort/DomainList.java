...
public class DomainList extends Window implements AfterCompose{
	...
	public void afterCompose() {
		...
		Components.addForwards(this, this);
		 downLevel.setTooltiptext("下级分类");
		 upLevel.setTooltiptext("上级分类");
			...
			public void onEvent(Event arg0) throws Exception {
				...
				if(radio1==null){
					...
					if(dList1.size() == 0){
						...
						domainCen.setTitle("所属分类："+domain0.getKiName());
						dList2 = dList1;
						loadGrid(dList1);	
					}
		...
		upLevel.addEventListener(Events.ON_CLICK, new EventListener(){
			...
			public void onEvent(Event arg0) throws Exception {
				...
				{
					domainRows.getChildren().clear();
				domainCen.setTitle("所属分类："+domainName(dList0));
				dList2 = dList0;
				loadGrid(dList0);	
				upANDdown(dList0);
				}
    ...
    public String domainName(List<WkTInfoDomain> list) throws InterruptedException{
    	String domainName;
    	if(list.size()!=0)
    	{
