...
//				}
	...
	public void onClick$replactTab(){
		ResultReplace rep=(ResultReplace)Executions.createComponents("/apps/infoExtra/content/tasktemp/replace.zul", null, null);
	...
	public void onClick$ieWindow(){
		IeExtract iExtract=(IeExtract)Executions.createComponents("/apps/infoExtra/content/tasktemp/ie.zul", null, null);
	...
	public void onClick$makesure(){
		...
		}else if((timePick.isChecked()==true) && (minunte.getValue()==null || minunte.getValue().equals("")) && (hour.getValue()==null || hour.getValue().equals(""))){
			MessageBox.showWarning("时间不能为空！");
		}*/else{
